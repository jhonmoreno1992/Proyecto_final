...
$categoria_peluches = 'Peluches';
$productos = $producto->obtenerProductosPorCategoria($categoria_peluches);
?>
...
<head>
    ...
    <title>Productos de Temporada - Detalles Con Dulzura</title>
</head>
        ...
        <header class="bg-dark py-5" style="background:url('../asset/custom/imagen2.jpg')">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-black">
                    <h1 class="display-4 fw-bolder">Peluches Tiernos</h1>
                    <p class="lead fw-normal text-black mb-0">Nunca Es Tarde Para Regalar Un Peluche</p>
                </div>
            </div>
        </header>
            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <?php if (empty($productos)): ?>
                        <div class="col-12">
                            <p class="text-center">No se encontraron productos en la categoría de Peluches.</p>
                        </div>
                    <?php else: ?>
