...
$categoria_anchetas = 'Anchetas';
$productos = $producto->obtenerProductosPorCategoria($categoria_anchetas);
?>
...
<head>
    ...
    <title>Productos de Amor - Detalles Con Dulzura</title>
</head>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex">
                    <a href="carrito.php" class="btn btn-outline-dark">
                        ...
                        Carrito
                        <span class="badge bg-dark text-white ms-1 rounded-pill" id="cartCount"><?php echo $totalItems; ?></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <header class="bg-dark py-5" style="background:url('../asset/custom/imagen2.jpg')">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-black">
                <h1 class="display-4 fw-bolder">Anchetas Amorosas</h1>
                <p class="lead fw-normal text-black mb-0">Encuentra los detalles perfectos para esa persona especial</p>
            </div>
        </div>
    </header>
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php if (empty($productos)): ?>
                    <div class="col-12">
                        <p class="text-center">No se encontraron productos en la categoría de Anchetas.</p>
                    </div>
                <?php else: ?>
